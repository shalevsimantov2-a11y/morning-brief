...
def setup_hebrew_font():
    ...
    if not os.path.exists(font_file):
        ...
        try:
            ...
            print("Failed to download Heebo font, fallback to system fonts:", e)
...
def main():
    ...
    title_style = ParagraphStyle('HebTitle', parent=styles['Normal'], fontName='HebrewFont-Bold', fontSize=17, leading=21, alignment=2, textColor=colors.HexColor("#1A365D"))
    subtitle_style = ParagraphStyle('HebSubtitle', parent=styles['Normal'], fontName='HebrewFont', fontSize=9.5, leading=13, alignment=2, textColor=colors.HexColor("#4A5568"))
    section_style = ParagraphStyle('HebSection', parent=styles['Normal'], fontName='HebrewFont-Bold', fontSize=12, leading=15, alignment=2, textColor=colors.HexColor("#2B6CB0"), spaceBefore=6, spaceAfter=3)
    bullet_style = ParagraphStyle('HebBullet', parent=styles['Normal'], fontName='HebrewFont', fontSize=8.5, leading=12, alignment=2, textColor=colors.HexColor("#1A202C"))
    deep_box_style = ParagraphStyle('HebDeepBox', parent=styles['Normal'], fontName='HebrewFont', fontSize=8.5, leading=12.5, alignment=2, textColor=colors.HexColor("#1A202C"))
    ...
    # Email Dispatch via env variables / secrets
    sender_email = os.getenv("GMAIL_USER", "shalevsimantov2@gmail.com")
    sender_password = os.getenv("GMAIL_APP_PASSWORD", "gewfxnhzycdtqoic").replace(" ", "")
    recipient_email = os.getenv("RECIPIENT_EMAIL", "shalevsimantov2@gmail.com")
